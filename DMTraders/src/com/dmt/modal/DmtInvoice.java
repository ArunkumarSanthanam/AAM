 ...
 */
@Entity
@Table(name="dmt_invoice")
@NamedQuery(name="DmtInvoice.findAll", query="SELECT d FROM DmtInvoice d")
public class DmtInvoice implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="dmt_invoice_invoice_id_seq", initialValue=1, allocationSize=1)
